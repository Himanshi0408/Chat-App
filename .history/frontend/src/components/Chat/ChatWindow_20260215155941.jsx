...
export default function ChatWindow({ chatWith }) {
  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      // Note: Message will be added via socket listener "receiveMessage"
      // This avoids duplicate messages in the UI
